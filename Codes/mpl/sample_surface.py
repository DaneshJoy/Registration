...
while not is_ok:
    ...
    elif 215<point_[0]<220 and 227<point_[1]<233 and 200<point_[2]<208  and len(surface_points_region2) < region_points:
        surface_points_region2.append(point_)
    elif 229<point_[0]<234 and 206<point_[1]<211 and 178<point_[2]<188  and len(surface_points_region3) < region_points:
...
np.savetxt('../../Tests/test1/surface_sampled.txt', surface_sampled, delimiter='\t', fmt='%.6f')   
